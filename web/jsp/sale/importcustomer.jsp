...
<%--
    Request attribute CustomerController#handleImportExcel có thể thiết lập
...
<head>
    ...
    <title>Nhập Excel khách hàng - POSCS Portal</title>
...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-header-row">
            <h2>Nhập Excel khách hàng</h2>
            <p>Tải file mẫu, điền thông tin theo đúng cột rồi tải lên để tạo hàng loạt khách hàng.</p>
        </div>
        ...
        <div class="card-box">
            <a class="template-link" href="${pageContext.request.contextPath}/customer?action=downloadTemplate">
