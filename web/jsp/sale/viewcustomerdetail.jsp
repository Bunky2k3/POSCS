...
<body>
    ...
    <div class="app-shell">
        <aside class="sidebar" id="sidebar">
            ...
            <a href="${pageContext.request.contextPath}/customer" class="sidebar-link active"><i class="fa-solid fa-users"></i><span>Khách hàng</span></a>
    ...
    <div class="page-container">
        ...
        <div class="detail-header card-box">
            ...
            <div class="header-actions">
                <button class="btn-edit-detail" type="button" onclick="document.getElementById('evaluateForm').submit();"><i class="fa-solid fa-chart-line"></i> Đánh giá lại xếp hạng</button>
    ...
    <!-- Form ẩn để chạy lại CustomerEvaluator qua POST -->
    <form id="evaluateForm" method="POST" action="${pageContext.request.contextPath}/customer" style="display:none">
        <input type="hidden" name="csrfToken" value="${csrfToken}">
