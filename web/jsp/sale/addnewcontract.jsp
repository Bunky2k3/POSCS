        ...
        <div class="card-box">
            <form id="createContractForm" action="${pageContext.request.contextPath}/contract" method="POST" onsubmit="return validateForm();">
                ...
                <div class="totals-box">
                    <div class="totals-row"><span>Tổng tiền hàng</span><span id="subTotal">900.000.000 đ</span></div>
                    <div class="totals-row"><span>Thuế GTGT (10%)</span><span id="vatTotal">90.000.000 đ</span></div>
                    <div class="totals-row grand"><span>Tổng cộng</span><span id="grandTotal">990.000.000 đ</span></div>
                </div>
