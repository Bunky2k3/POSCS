...
('KH-0001', 'Công ty Cổ phần Viễn thông Sông Hồng', 'Nhà mạng viễn thông', 'VIP', '0101234501', 'contact@songhongtelecom.vn', '0243826001', 'https://songhongtelecom.vn', (SELECT address_id FROM addresses WHERE street_and_local_name = 'Số 15 Phố Duy Tân' ORDER BY address_id DESC LIMIT 1), (SELECT user_id FROM users WHERE username = 'sales2'), 'Trần Văn Hùng', 'Tốt', '2022-03-10');
INSERT INTO enterprises (enterprise_code, enterprise_name, customer_type, customer_group, tax_code, email, phone, website, address_id, account_owner_id, legal_representative, current_relationship_rating, join_date) VALUES
('KH-0002', 'Công ty TNHH Viễn thông Miền Nam Phát', 'Nhà mạng viễn thông', 'Thân thiết', '0301234502', 'info@miennamphat.vn', '0283922002', 'https://miennamphat.vn', (SELECT address_id FROM addresses WHERE street_and_local_name = '88 Đường Cộng Hòa' ORDER BY address_id DESC LIMIT 1), (SELECT user_id FROM users WHERE username = 'sales3'), 'Lê Thị Mai', 'Tốt', '2021-11-05');
INSERT INTO enterprises (enterprise_code, enterprise_name, customer_type, customer_group, tax_code, email, phone, website, address_id, account_owner_id, legal_representative, current_relationship_rating, join_date) VALUES
('KH-0003', 'Công ty Cổ phần Hạ tầng Mạng Việt Á', 'Nhà mạng viễn thông', 'Tiềm năng', '0401234503', 'contact@vietanetwork.vn', '0236377003', 'https://vietanetwork.vn', (SELECT address_id FROM addresses WHERE street_and_local_name = '20 Đường Nguyễn Văn Linh' ORDER BY address_id DESC LIMIT 1), (SELECT user_id FROM users WHERE username = 'sales4'), 'Phạm Quốc Bảo', 'Cần theo dõi', '2024-06-20');
INSERT INTO enterprises (enterprise_code, enterprise_name, customer_type, customer_group, tax_code, email, phone, website, address_id, account_owner_id, legal_representative, current_relationship_rating, join_date) VALUES
('KH-0004', 'Công ty TNHH Xây dựng Viễn thông Thăng Long', 'Nhà thầu thi công', 'VIP', '0101234504', 'contact@thanglongtelecom.vn', '0243662004', 'https://thanglongtelecom.vn', (SELECT address_id FROM addresses WHERE street_and_local_name = '45 Phố Tây Sơn' ORDER BY address_id DESC LIMIT 1), (SELECT user_id FROM users WHERE username = 'sales5'), 'Nguyễn Đức Thắng', 'Tốt', '2020-08-15');
INSERT INTO enterprises (enterprise_code, enterprise_name, customer_type, customer_group, tax_code, email, phone, website, address_id, account_owner_id, legal_representative, current_relationship_rating, join_date) VALUES
('KH-0005', 'Công ty Cổ phần Xây lắp Điện & Viễn thông Phương Nam', 'Nhà thầu thi công', 'Thân thiết', '0301234505', 'info@phuongnamelectric.vn', '0283998005', 'https://phuongnamelectric.vn', (SELECT address_id FROM addresses WHERE street_and_local_name = '102 Đường Xô Viết Nghệ Tĩnh' ORDER BY address_id DESC LIMIT 1), (SELECT user_id FROM users WHERE username = 'sales6'), 'Võ Thành Nam', 'Tốt', '2022-01-25');
INSERT INTO enterprises (enterprise_code, enterprise_name, customer_type, customer_group, tax_code, email, phone, website, address_id, account_owner_id, legal_representative, current_relationship_rating, join_date) VALUES
('KH-0006', 'Công ty TNHH Thi công Cơ điện Hải Phòng', 'Nhà thầu thi công', 'Thường', '0201234506', 'lienhe@codienhaiphong.vn', '0225382006', NULL, (SELECT address_id FROM addresses WHERE street_and_local_name = '12 Đường Lạch Tray' ORDER BY address_id DESC LIMIT 1), (SELECT user_id FROM users WHERE username = 'sales2'), 'Đỗ Văn Kiên', 'Cần theo dõi', '2023-09-12');
INSERT INTO enterprises (enterprise_code, enterprise_name, customer_type, customer_group, tax_code, email, phone, website, address_id, account_owner_id, legal_representative, current_relationship_rating, join_date) VALUES
('KH-0007', 'Công ty Cổ phần Đầu tư Xây dựng Bắc Ninh', 'Nhà thầu thi công', 'Tiềm năng', '0231234507', 'info@xaydungbacninh.vn', '0222371007', 'https://xaydungbacninh.vn', (SELECT address_id FROM addresses WHERE street_and_local_name = '56 Đường Kinh Dương Vương' ORDER BY address_id DESC LIMIT 1), (SELECT user_id FROM users WHERE username = 'sales3'), 'Nguyễn Thị Hòa', 'Cần theo dõi', '2025-02-18');
INSERT INTO enterprises (enterprise_code, enterprise_name, customer_type, customer_group, tax_code, email, phone, website, address_id, account_owner_id, legal_representative, current_relationship_rating, join_date) VALUES
('KH-0008', 'Công ty TNHH Phân phối Thiết bị Viễn thông An Phát', 'Đại lý phân phối', 'VIP', '0301234508', 'sales@anphatdistribution.vn', '0283845008', 'https://anphatdistribution.vn', (SELECT address_id FROM addresses WHERE street_and_local_name = '77 Đường Phan Xích Long' ORDER BY address_id DESC LIMIT 1), (SELECT user_id FROM users WHERE username = 'sales4'), 'Trịnh Minh Tuấn', 'Tốt', '2019-05-30');
INSERT INTO enterprises (enterprise_code, enterprise_name, customer_type, customer_group, tax_code, email, phone, website, address_id, account_owner_id, legal_representative, current_relationship_rating, join_date) VALUES
('KH-0009', 'Công ty Cổ phần Thương mại Thiết bị Công nghệ Đồng Nai', 'Đại lý phân phối', 'Thân thiết', '0361234509', 'contact@dncntech.vn', '0251389009', 'https://dncntech.vn', (SELECT address_id FROM addresses WHERE street_and_local_name = '34 Đường Đồng Khởi' ORDER BY address_id DESC LIMIT 1), (SELECT user_id FROM users WHERE username = 'sales5'), 'Hoàng Văn Phúc', 'Tốt', '2021-07-08');
INSERT INTO enterprises (enterprise_code, enterprise_name, customer_type, customer_group, tax_code, email, phone, website, address_id, account_owner_id, legal_representative, current_relationship_rating, join_date) VALUES
('KH-0010', 'Công ty TNHH Đại lý Thiết bị Viễn thông Nha Trang', 'Đại lý phân phối', 'Thường', '0421234510', 'info@nhatrangtelecom.vn', '0258356010', NULL, (SELECT address_id FROM addresses WHERE street_and_local_name = '9 Đường Trần Phú' ORDER BY address_id DESC LIMIT 1), (SELECT user_id FROM users WHERE username = 'sales6'), 'Lâm Thị Kim Ngân', 'Cần theo dõi', '2023-12-01');
INSERT INTO enterprises (enterprise_code, enterprise_name, customer_type, customer_group, tax_code, email, phone, website, address_id, account_owner_id, legal_representative, current_relationship_rating, join_date) VALUES
('KH-0011', 'Công ty Cổ phần Vật tư Viễn thông Thanh Hóa', 'Đại lý phân phối', 'Tiềm năng', '0381234511', 'lienhe@vattuthanhhoa.vn', '0237372011', 'https://vattuthanhhoa.vn', (SELECT address_id FROM addresses WHERE street_and_local_name = '18 Đường Lê Lợi' ORDER BY address_id DESC LIMIT 1), (SELECT user_id FROM users WHERE username = 'sales2'), 'Bùi Xuân Trường', 'Tốt', '2024-10-14');
INSERT INTO enterprises (enterprise_code, enterprise_name, customer_type, customer_group, tax_code, email, phone, website, address_id, account_owner_id, legal_representative, current_relationship_rating, join_date) VALUES
('KH-0012', 'Công ty TNHH Xây dựng Hạ tầng Viễn thông Nghệ An', 'Nhà thầu thi công', 'Thường', '0291234512', 'info@hatangnghean.vn', '0238381012', NULL, (SELECT address_id FROM addresses WHERE street_and_local_name = '63 Đường Lê Duẩn' ORDER BY address_id DESC LIMIT 1), (SELECT user_id FROM users WHERE username = 'sales3'), 'Cao Văn Đạt', 'Có nguy cơ rời bỏ', '2020-02-28');
