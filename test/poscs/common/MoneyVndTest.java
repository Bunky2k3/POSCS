...
public class MoneyVndTest {
    ...
    @Test
    public void chuoiTuCsdlKhongBiNhan100() {
    ...
    @Test
    public void dauPhayThapPhanCungKhongBiNhan100() {
    ...
    @Test
    public void soTranDocDuoc() {
        bang("1500000000", "1500000000");
        bang("0", "0");
    }

    @Test
    public void dauChamPhanNhomKieuVietNam() {
        bang("1500000000", "1.500.000.000");
        bang("980000000", "980.000.000");
    }

    @Test
    public void dauPhayPhanNhomKieuAnhMy() {
        // Có người quen gõ kiểu này, và Excel dán ra cũng hay ra dạng này.
        bang("1500000000", "1,500,000,000");
    }

    @Test
    public void motDauChamVoiDuNhomBaChuSoLaPhanNhom() {
    ...
    @Test
    public void nhomCuoiKhacBaChuSoLaThapPhan() {
        bang("1.5", "1.5");
        bang("1.5", "1,5");
    }

    @Test
    public void caHaiLoaiDauThiDauSauLaThapPhan() {
        bang("1500.75", "1.500,75");
        bang("1500.75", "1,500.75");
    }

    @Test
    public void khoangTrangBiBoQua() {
        bang("980000000", " 980 000 000 ");
    ...
    @Test
    public void nhieuHonHaiChuSoThapPhanThiLamTron() {
    ...
    @Test
    public void chuoiKhongDocDuocThiTraNullChuKhongNem() {
